    ...
    public partial class FindReplaceDialog : Form
    {
        ...
        private void btnFindAll_Click(object sender, EventArgs e)
        {
            ...
            if (rdoRegexF.Checked)
            {
                ...
                {
                    lblStatus.Text = "正則表達式中的錯誤： " + ex.Message;
                    return;
                }
            ...
            lblStatus.Text = "總共找到： " + foundRanges.Count.ToString();
        ...
        private void btnReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            lblStatus.Text = "總共取代： " + foundRanges.Count.ToString();
        }
        ...
        private void btnReplacePrevious_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (chkSearchSelectionR.Checked)
                        lblStatus.Text = "搜索匹配中到選擇的開頭";
                    else
                        lblStatus.Text = "搜索匹配中到文檔的開頭";
                }
        ...
        public void FindPrevious()
        {
            ...
            else
            {
                ...
                {
                    if (chkSearchSelectionF.Checked)
                        lblStatus.Text = "搜索匹配中到選擇的結尾";
                    else
                        lblStatus.Text = "搜索匹配中到文檔的結尾";
                }
